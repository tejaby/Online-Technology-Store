...
if (!empty($_POST['emailU']) && !empty($_POST['passwordU'])) {
  ...
  //vincular 
  $stmt->bindParam(':email', $_POST['emailU']);
  //cifrar la contraseña
  $password = password_hash($_POST['passwordU'], PASSWORD_BCRYPT);
  ...
  <div class="container w-50 mt-5  mt-5 rounded shadow">
    <div class="row align-items">
      ...
      <div class="col bg-light p-4 rounded">
        ...
        <h2 class="fw-boldf text-center py-4">Crear una cuenta</h2>
        ...
        <form action="signup.php" method="POST">
          ...
          <?php if (!empty($mensaje)) : ?>
            <div class="alert alert-success" role="alert"><?= $mensaje ?>
              <br>
              <div class="d-grid">
                <button type="submit" value="Submit" class="btn btn-outline-success"><a href="login.php" style="text-decoration: none; color:#FFFFFF">iniciar sesion</a></button>
              </div>
            </div>
          <?php endif; ?>
